...
<Mermaid chart={`flowchart LR
    ...
    classDef lightGreen fill:#d3f9b5,stroke:#772d8b,stroke-width:2px
    class GM1 darkRed
    class GM2 darkPurple
    class GM3 teal
    class GM4 lightPink
    class GM5 lightGreen
    class GM6 darkRed
    class GM7 darkPurple`} client:load />
...
export const contextWindowData = [
  { provider: 'Gemini 2.5 Pro', icon: '⚡', value: '1,000,000', unit: ' tokens', color: '#bf5af2' },
  { provider: 'GPT-5', icon: '✨', value: '400,000', unit: ' tokens', color: '#34c759' },
  { provider: 'Claude Sonnet 4.5', icon: '🤖', value: '200,000', unit: ' tokens', color: '#0071e3' }
]

export const outputWindowData = [
  { provider: 'GPT-5', value: 128, unit: 'K tokens', color: '#34c759', icon: '✨' },
  { provider: 'Claude Sonnet 4.5', value: 64, unit: 'K tokens', color: '#0071e3', icon: '🤖' },
  { provider: 'Gemini 2.5 Pro', value: 8, unit: 'K tokens', color: '#bf5af2', icon: '⚡' }
]
...
<MetricCard
  title="2025年旗舰模型发布时间"
  items={[
    { provider: 'Gemini 2.5 Pro', value: '2025年3月', icon: '⚡', color: '#bf5af2', note: '首发超长上下文' },
    { provider: 'GPT-5', value: '2025年8月', icon: '✨', color: '#34c759', note: '智能路由系统' },
    { provider: 'Claude Sonnet 4.5', value: '2025年9月', icon: '🤖', color: '#0071e3', note: '代码能力突破' }
  ]}
  type="number"
/>
  ...
  coding: (
    <div>
      ...
      <MetricCard
        ...
        items={[
          { provider: 'Claude Sonnet 4.5', value: 82, unit: '%', color: '#0071e3', icon: '🤖' },
          { provider: 'GPT-5', value: 74.9, unit: '%', color: '#34c759', icon: '✨' },
          { provider: 'Gemini 2.5 Pro', value: 67.2, unit: '%', color: '#bf5af2', icon: '⚡' }
        ]}
        type="bar"
      />
      <h4>各平台优势：</h4>
  ...
  research: (
    <div>
      ...
      <MetricCard
        ...
        items={[
          { provider: 'Gemini 2.5 Pro', value: 84.0, unit: '%', color: '#bf5af2', icon: '⚡' },
          { provider: 'GPT-5', value: 83.0, unit: '%', color: '#34c759', icon: '✨' },
          { provider: 'Claude Sonnet 4.5', value: 83.4, unit: '%', color: '#0071e3', icon: '🤖' }
        ]}
        type="bar"
      />
      <h4>研究优势：</h4>
...
<TabComparison
  tabs={[
    { id: 'coding', label: '编程开发', icon: '💻', color: '#0071e3', content: useCaseContent.coding },
    { id: 'writing', label: '内容创作', icon: '✍️', color: '#34c759', content: useCaseContent.writing },
    { id: 'research', label: '研究分析', icon: '🔬', color: '#bf5af2', content: useCaseContent.research }
  ]}
  defaultTab="coding"
/>
...
<Mermaid chart={`flowchart TB
    ...
    classDef lightGreen fill:#d3f9b5,stroke:#772d8b,stroke-width:2px
    class CAI darkRed
    class RLHF darkPurple`} client:load />
...
<Mermaid chart={`flowchart TB
    ...
    style Native fill:#e6f2ff,color:#1d1d1f
    style Google fill:#f3e5ff,color:#1d1d1f
    style Knowledge fill:#fff4e6,color:#1d1d1f`} client:load />
...
<Mermaid chart={`flowchart TD
    ...
    class Q5 lightGreen
    class GPT darkRed
    class GPT2 darkPurple`} client:load />
...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem', margin: '2rem 0', padding: '2rem', background: '#f5f5f7', borderRadius: '1rem' }}>
  <div style={{ padding: '1.5rem', background: 'white', borderRadius: '0.75rem', borderTop: '4px solid #0071e3' }}>
    <h3 style={{ color: '#0071e3', marginTop: 0 }}>🤖 Claude Sonnet 4.5</h3>
    ...
    <p style={{ fontSize: '0.9rem', color: '#86868b', marginTop: '1rem' }}><strong>价格定位:</strong> 高端 ($3/$15)</p>
  </div>

  <div style={{ padding: '1.5rem', background: 'white', borderRadius: '0.75rem', borderTop: '4px solid #0071e3' }}>
    <h3 style={{ color: '#34c759', marginTop: 0 }}>✨ GPT-5</h3>
    <p><strong>最佳场景：</strong></p>
    <ul style={{ marginLeft: '1.5rem' }}>
    ...
    <p style={{ fontSize: '0.9rem', color: '#86868b', marginTop: '1rem' }}><strong>价格定位:</strong> 性价比 ($1.25/$10)</p>
  </div>

  <div style={{ padding: '1.5rem', background: 'white', borderRadius: '0.75rem', borderTop: '4px solid #bf5af2' }}>
    <h3 style={{ color: '#bf5af2', marginTop: 0 }}>⚡ Gemini 2.5 Pro</h3>
    <p><strong>最佳场景：</strong></p>
    <ul style={{ marginLeft: '1.5rem' }}>
...
<MetricCard
  ...
  items={[
    { provider: 'GPT-5', value: 5.625, unit: ' USD', color: '#34c759', icon: '✨' },
    { provider: 'Gemini 2.5 Pro', value: 5.625, unit: ' USD', color: '#bf5af2', icon: '⚡' },
    { provider: 'Claude Sonnet 4.5', value: 9.00, unit: ' USD', color: '#0071e3', icon: '🤖' }
  ]}
  type="bar"
/>

<div style={{ background: '#fbfbfd', padding: '1.5rem', borderRadius: '0.75rem', marginTop: '2rem', borderLeft: '4px solid #0071e3' }}>
  <h4 style={{ marginTop: 0, color: '#0071e3' }}>💡 价格洞察</h4>
...
<Mermaid chart={`timeline
    ...
    2025 Q4 : 持续迭代 : 各平台优化中`} client:load />
