...
import ComparisonTable from '../../components/materials/ComparisonTable'
import FeatureGrid from '../../components/materials/FeatureGrid'
import TabComparison from '../../components/materials/TabComparison'
import MetricCard from '../../components/materials/MetricCard'
import PricingCard from '../../components/materials/PricingCard'
...
<Mermaid chart={`flowchart LR
    ...
    class CLI darkRed
    class BG darkPurple`} client:load />
...
<Mermaid chart={`flowchart TB
    ...
    classDef lightGreen fill:#d3f9b5,stroke:#772d8b,stroke-width:2px
    class UI darkRed
    class GPT darkPurple`} client:load />
...
<Mermaid chart={`flowchart LR
    ...
    classDef lightGreen fill:#d3f9b5,stroke:#772d8b,stroke-width:2px
    class CLI darkRed
    class MCP darkPurple`} client:load />
...
<Mermaid chart={`sequenceDiagram
    ...
    Dev->>Codex: 批准执行
    Codex->>Codex: 本地代码审查
    Codex-->>Dev: 执行完成，运行测试`} client:load />
...
export const contextWindowData = [
  { provider: 'Claude Code 2.0', icon: '🤖', value: '1,000,000', unit: ' tokens (Beta)', color: '#0071e3' },
  { provider: 'Codex CLI', icon: '⚡', value: '400,000', unit: ' tokens', color: '#bf5af2' },
  { provider: 'Claude Code 2.0', icon: '🤖', value: '200,000', unit: ' tokens (默认)', color: '#0071e3' },
  { provider: 'Cursor', icon: '✨', value: '可变', unit: ' (取决于模型)', color: '#34c759' }
]

export const outputCapacityData = [
  { provider: 'Claude Code', value: 128, unit: 'K tokens', color: '#0071e3', icon: '🤖' },
  { provider: 'Codex CLI', value: '未公开', unit: '', color: '#bf5af2', icon: '⚡' },
  { provider: 'Cursor', value: '取决于模型', unit: '', color: '#34c759', icon: '✨' }
]
...
<MetricCard
  title="2025年主要里程碑"
  items={[
    { provider: 'Cursor', value: '2022年启动', icon: '✨', color: '#34c759', note: 'MIT团队创立' },
    { provider: 'Codex CLI', value: '2025年4月', icon: '⚡', color: '#bf5af2', note: '开源发布' },
    { provider: 'Claude Code 2.0', value: '2025年9月29日', icon: '🤖', color: '#0071e3', note: 'VS Code Ext + 1M Context' },
    { provider: 'GPT-5-Codex', value: '2025年9月', icon: '⚡', color: '#bf5af2', note: 'Adaptive Reasoning' },
    { provider: 'Cursor 2.0', value: '2025年10月', icon: '✨', color: '#34c759', note: 'Composer模型发布' }
  ]}
  type="number"
/>
  ...
  terminal: (
    <div>
      ...
      <MetricCard
        title="终端工作流适配度"
        items={[
          { provider: 'Claude Code', value: 100, unit: '/100', color: '#0071e3', icon: '🤖', note: '原生CLI设计' },
          { provider: 'Codex CLI', value: 95, unit: '/100', color: '#bf5af2', icon: '⚡', note: '开源CLI + MCP' },
          { provider: 'Cursor', value: 20, unit: '/100', color: '#34c759', icon: '✨', note: 'GUI优先' }
        ]}
        type="bar"
      />
      <h4>终端场景优势：</h4>
  ...
  complex: (
    <div>
      ...
      <MetricCard
        title="复杂任务处理能力"
        items={[
          { provider: 'Codex CLI', value: 95, unit: '/100', color: '#bf5af2', icon: '⚡', note: 'Adaptive Reasoning 7h' },
          { provider: 'Cursor', value: 90, unit: '/100', color: '#34c759', icon: '✨', note: 'Agent多文件重构' },
          { provider: 'Claude Code', value: 85, unit: '/100', color: '#0071e3', icon: '🤖', note: 'Subagents并行' }
        ]}
        type="bar"
      />
      <h4>复杂任务特性：</h4>
  ...
  cost: (
    <div>
      ...
      <MetricCard
        title="月费成本对比（个人起步价）"
        items={[
          { provider: 'Codex CLI', value: 20, unit: ' USD/月', color: '#bf5af2', icon: '⚡', note: 'ChatGPT Plus' },
          { provider: 'Cursor', value: 20, unit: ' USD/月', color: '#34c759', icon: '✨', note: 'Pro' },
          { provider: 'Claude Code', value: 'N/A', unit: ' (需订阅)', color: '#0071e3', icon: '🤖', note: 'Claude.ai付费' }
        ]}
        type="bar"
      />
      <h4>成本考量：</h4>
...
<TabComparison
  tabs={[
    { id: 'terminal', label: '终端工作流', icon: '💻', color: '#0071e3', content: useCaseContent.terminal },
    { id: 'complex', label: '复杂重构', icon: '🔧', color: '#bf5af2', content: useCaseContent.complex },
    { id: 'cost', label: '成本优先', icon: '💰', color: '#34c759', content: useCaseContent.cost }
  ]}
  defaultTab="terminal"
/>
...
<Mermaid chart={`flowchart LR
    ...
    style Decision fill:#e6f2ff,color:#1d1d1f
    style Deep fill:#f3e5ff,color:#1d1d1f
    style Review fill:#e6f4ed,color:#1d1d1f`} client:load />
...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem', margin: '2rem 0', padding: '2rem', background: '#f5f5f7', borderRadius: '1rem' }}>
  <div style={{ padding: '1.5rem', background: 'white', borderRadius: '0.75rem', borderTop: '4px solid #0071e3' }}>
    <h3 style={{ color: '#0071e3', marginTop: 0 }}>🤖 Claude Code 2.0</h3>
    ...
    <p style={{ fontSize: '0.9rem', color: '#86868b', marginTop: '1rem' }}><strong>价格:</strong> API $3/$15/M，1M需Tier 4/Max 20x</p>
  </div>

  <div style={{ padding: '1.5rem', background: 'white', borderRadius: '0.75rem', borderTop: '4px solid #0071e3' }}>
    <h3 style={{ color: '#34c759', marginTop: 0 }}>✨ Cursor</h3>
    <p><strong>最佳场景：</strong></p>
    <ul style={{ marginLeft: '1.5rem' }}>
    ...
    <p style={{ fontSize: '0.9rem', color: '#86868b', marginTop: '1rem' }}><strong>价格:</strong> Free试用，Pro $20/月</p>
  </div>

  <div style={{ padding: '1.5rem', background: 'white', borderRadius: '0.75rem', borderTop: '4px solid #ff2d55' }}>
    <h3 style={{ color: '#bf5af2', marginTop: 0 }}>⚡ Codex CLI</h3>
    <p><strong>最佳场景：</strong></p>
    <ul style={{ marginLeft: '1.5rem' }}>
    ...
    <p style={{ fontSize: '0.9rem', color: '#86868b', marginTop: '1rem' }}><strong>价格:</strong> ChatGPT Plus $20/月起</p>
  </div>
</div>
...
<MetricCard
  ...
  items={[
    { provider: 'Codex CLI', value: 20, unit: ' USD/月', color: '#bf5af2', icon: '⚡', note: 'ChatGPT Plus' },
    { provider: 'Cursor', value: 20, unit: ' USD/月', color: '#34c759', icon: '✨', note: 'Pro (Free试用)' },
    { provider: 'Claude Code', value: 'N/A', unit: ' (需订阅)', color: '#0071e3', icon: '🤖', note: 'Claude.ai' }
  ]}
  type="bar"
/>

<div style={{ background: '#fbfbfd', padding: '1.5rem', borderRadius: '0.75rem', marginTop: '2rem', borderLeft: '4px solid #bf5af2' }}>
  <h4 style={{ marginTop: 0, color: '#bf5af2' }}>💡 价格洞察</h4>
...
<MetricCard
  ...
  items={[
    { provider: 'Claude Code 2.0 (Sonnet 4.5)', value: 82.0, unit: '%', color: '#0071e3', icon: '🤖', note: '比前版本↑76%' },
    { provider: 'Codex CLI (GPT-5-Codex)', value: 51.3, unit: '%', color: '#bf5af2', icon: '⚡', note: 'Adaptive Reasoning' },
    { provider: 'Cursor (多模型)', value: '可变', unit: '', color: '#34c759', icon: '✨', note: '取决于所选模型' }
  ]}
  type="bar"
/>
...
<MetricCard
  title="代码重构能力评分 (综合评测)"
  items={[
    { provider: 'Cursor', value: 92, unit: '/100', color: '#34c759', icon: '✨', note: 'AIMultiple综合' },
    { provider: 'Claude Code 2.0', value: 90, unit: '/100', color: '#0071e3', icon: '🤖', note: 'SWE-bench + 综合' },
    { provider: 'Codex CLI', value: 85, unit: '/100', color: '#bf5af2', icon: '⚡', note: 'OpenAI官方' }
  ]}
  type="bar"
/>
...
<Mermaid chart={`timeline
    ...
    2026 Q3 : 预测 统一协议 : MCP成为标准`} client:load />
